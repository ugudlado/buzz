...
>) {
  ...
  for (const { project, pullRequest, repository } of pullRequests) {
    ...
    items.push({
      ...
      actorName: pullRequest.authorKind === "nostr" ? null : pullRequest.author,
  ...
  for (const { project, issue, repository } of issues) {
    ...
    items.push({
      ...
      actorPubkey: issue.authorKind === "nostr" ? issue.author : null,
      actorName: issue.authorKind === "nostr" ? null : issue.author,
